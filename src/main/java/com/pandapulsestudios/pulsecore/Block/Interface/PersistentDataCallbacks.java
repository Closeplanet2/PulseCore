...
public interface PersistentDataCallbacks {
    default void RegisteredPersistentData(){ ChatAPI.SendChat(String.format("&3Registered Persistent Data: %s", getClass().getSimpleName()), MessageType.ConsoleMessageNormal, true, null); }
