    ...
    public void onEvent(PlayerJoinEvent event){
        ...
        for(var itemStack : inventoryItems.keySet()){
            for(var pulseEnchantment : EnchantmentAPI.ReturnCustomEnchantmentOnItems(itemStack)){
                pulseEnchantment.PlayerJoinEvent(event, itemStack, inventoryItems.get(itemStack));
            }
        }
        ...
        for(var itemStack : inventoryItems.keySet()){
            ...
            pulseItemStack.PlayerJoinEvent(event, itemStack, inventoryItems.get(itemStack));
        }
        ...
        for(var pulseLocation :  LocationAPI.ReturnAllPulseLocations(eventLocation, true)){
            pulseLocation.PlayerJoinEvent(event, eventLocation);
        }
    }
}
