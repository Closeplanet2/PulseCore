...
public interface PersistentDataCallbacks {
    ...
    default void PlayerExpChangeEvent(PlayerExpChangeEvent event, Block block, LinkedHashMap<PersistentDataTypes, LinkedHashMap<String, Object>> tags){  }
    default boolean PlayerFishEvent(PlayerFishEvent event, Block block, LinkedHashMap<PersistentDataTypes, LinkedHashMap<String, Object>> tags){ return false; }
    ...
    default void PlayerItemBreakEvent(PlayerItemBreakEvent event, Block block, LinkedHashMap<PersistentDataTypes, LinkedHashMap<String, Object>> tags){  }
    ...
    default void PlayerJoinEvent(PlayerJoinEvent event, Block block, LinkedHashMap<PersistentDataTypes, LinkedHashMap<String, Object>> tags){  }
    default void PlayerLevelChangeEvent(PlayerLevelChangeEvent event, Block block, LinkedHashMap<PersistentDataTypes, LinkedHashMap<String, Object>> tags){  }
    ...
    default void PlayerRespawnEvent(PlayerRespawnEvent event, Block block, LinkedHashMap<PersistentDataTypes, LinkedHashMap<String, Object>> tags){  }
