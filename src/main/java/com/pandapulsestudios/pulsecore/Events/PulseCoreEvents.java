...
public interface PulseCoreEvents {
    ...
    default boolean EntityCombustByEntityEvent(EntityCombustByEntityEvent event){ return false; }
    default boolean EntityDamageByBlockEvent(EntityDamageByBlockEvent event){ return false; }
    default boolean EntityDamageByEntityEvent(EntityDamageByEntityEvent event){ return false; }
