...
public class PandaEntityBossBarPlayerRemoveEvent extends Event implements Cancellable {
    private static final HandlerList handlers = new HandlerList();
    private boolean cancelled;
    private final PandaEntityBossBar pandaBossBar;
    private final Player player;

    public PandaEntityBossBarPlayerRemoveEvent(PandaEntityBossBar pandaBossBar, Player player){
