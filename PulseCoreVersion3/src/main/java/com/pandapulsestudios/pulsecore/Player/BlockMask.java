...
public class BlockMask {
    ...
    public static class Builder {
        ...
        public BlockMask CreateMask(Player player){
            var storedBlockMask = PulseCore.blockMasksPerPlayer.getOrDefault(player.getUniqueId(), null);
            ...
            PulseCore.blockMasksPerPlayer.put(player.getUniqueId(), createdBlockMask);
