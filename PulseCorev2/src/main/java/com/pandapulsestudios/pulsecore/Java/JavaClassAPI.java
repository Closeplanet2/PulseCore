...
public class JavaClassAPI {
    ...
    public static void Register(JavaPlugin javaPlugin) throws Exception {
        var interfaceClasses = JavaAPI.ReturnALlClassOfTypes(javaPlugin, CustomEnchantment.class, CustomEvent.class,
                ...
                CustomPersistentData.class, CustomCoreEvents.class, CustomWorld.class);
        ...
        for(var itemStackInterface : interfaceClasses.get(CustomWorld.class)) Register((PulseWorld) itemStackInterface.getConstructor().newInstance());
    }
    ...
    private static void Register(PulseItemStack pulseItemStack){
        PulseCoreMain.registeredItemStacks.put(ChatColor.stripColor(pulseItemStack.itemName()), pulseItemStack);
