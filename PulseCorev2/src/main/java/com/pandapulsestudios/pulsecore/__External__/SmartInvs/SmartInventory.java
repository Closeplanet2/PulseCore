...
import com.pandapulsestudios.pulsecore.__External__.SmartInvs.content.InventoryProvider;
...
public class SmartInventory {
    ...
    public static final class Builder {
        ...
        public SmartInventory build() {
            ...
            InventoryManager manager = this.manager != null ? this.manager : PulseCoreMain.manager();
